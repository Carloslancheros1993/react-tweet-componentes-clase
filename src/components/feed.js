...
export default function Feed(props) {
  ...
  //const content =
    //"lorem hjjkasasjdabchhjkasdjhjasd hajsdjkjhhjhjjhsad lorem hjjkasasjdabchhjkasdjhjasd";
 const {profile, profileName, username, content , display} = props.datos;

  return (
    <div>
      <button onClick={() => props.mostrar()}>Mostrar Tweets Ocultos</button>
      <button onClick={() => props.ocultar()}>Ocultar Tweets Ocultos</button>
      {
        display ?
      <Tweet
        profile={profile}
